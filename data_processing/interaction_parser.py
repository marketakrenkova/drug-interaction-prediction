...
def parse_drug_interactions(data_dir):
    interactions_df = pd.read_csv(data_dir + 'drug_interactions.csv', index_col=[0])

    drug_id_map = pd.read_csv(data_dir + 'drug_id_name_map.csv', index_col=[0])
...
def parse_food_interactions(data_dir):
    food_interactions = pd.read_csv(data_dir + 'drug_food_interactions.csv', index_col=[0])
    drugs = pd.read_csv(data_dir + 'drug_id_name_map.csv', index_col=[0])
...
# parse_drug_interactions(data_dir)
parse_food_interactions(data_dir)
